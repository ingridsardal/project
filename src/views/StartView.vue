...
<body class="background">
    <header>
        <div v-bind:class="['hamburger', {'close': !hideNav}]" v-on:click="toggleNav" ref="hamburgerMenu">
        </div>
        <div class="logo">
...
#createButton {
    ...
    border: 2px solid rgba(249, 192, 86, 0.6);
    cursor: pointer;
    font-family: 'Open Sans', sans-serif;
    font-size: 1.5rem;
}
...
#navButtons {
    ...
    background-color: rgb(249, 192, 86);
    color: white;
    border: 2px solid rgba(255, 226, 173, 0.6);
    cursor: pointer;
    box-shadow: none;
}
