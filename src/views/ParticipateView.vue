      ...
      <section>
        <div class="wrapper">
          <button class="avatars"
            :class="{ 'selected-avatar': selectedGif === 'https://media.giphy.com/media/xT9IgM7SyNjzZBxvDG/giphy.gif' }"
          ...
          <button class="avatars"
            :class="{ 'selected-avatar': selectedGif === 'https://media.giphy.com/media/etKPlfE85HW8udMMDl/giphy.gif' }"
          ...
          <button class="avatars"
            :class="{ 'selected-avatar': selectedGif === 'https://media.giphy.com/media/w0hpqElNgofh1bdUD3/giphy.gif' }"
          ...
          <button class="avatars"
            :class="{ 'selected-avatar': selectedGif === 'https://media.giphy.com/media/u7e9QxCHnNzWxswBZJ/giphy.gif' }"
...
.wrapper {
  ...
  /* Centers the wrapper */
  padding-left: 50px;
  /* Adds 50px of padding to the left */
  padding-right: 50px;
  /* Adds 50px of padding to the right */
  margin-bottom: 40px;
  /* Space between the grid and the selected avatar */
  height: 10px;
}
